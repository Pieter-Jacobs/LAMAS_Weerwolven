...
class Night:
    def __init__(self, ks, n_villagers, n_mafia, n_detectives):
        self.ks = ks
    ...
    def mafia_phase(self):
        ...
        mafia = [player for player in self.ks.players if player.role == "mafia" and player.alive]
        killable_players = [player for player in self.ks.players if player not in mafia and player.alive]
    ...
    def detective_phase(self):
        ...
        detectives = [player for player in self.ks.players if player.role == "detective"]
        eligible_players = [player for player in self.ks.players if player not in detectives and player.alive == True]
